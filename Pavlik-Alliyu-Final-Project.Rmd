...
So, I am terrible at coding. Let me know if it is okay if you work on coding the stuff below. I have ideqas for each, I just dont know how to write the code. IF you do a lot of the coding, I can take care of explaing everything, narrarating, and the guidance document. Thanks!

## Data Wrangling Portion
* Use of spread and gather  
    + Used spread, NOT gather
* Use of regular expressions           
    + Trying to look for article on abuse
* User-defined functions    
    + See if you can find a way to create a function to remove even rows
