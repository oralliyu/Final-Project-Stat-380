...
* Use of spread and gather               Used spread, NOT gather
* Use of regular expressions            Trying to look for article on abuse
* User-defined functions     See if you can find a way to create a function to remove even rows
* Loops and/or control flow       Use loop in function?
