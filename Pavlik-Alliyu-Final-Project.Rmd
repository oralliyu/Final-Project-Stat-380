...
* Use of spread and gather  
    + Used spread, NOT gather yet
* Use of regular expressions 
    + I WILL TAKE CARE OF THIS, JUST DIDNT HAVE TIME TO DO IT TONIGHT (unless you wanna attempt it)
...
* Analysis of text data
    + I WILL ALSO DO THIS PART, JUST RAN OUT OF TIME ONCE AGAIN TONIGHT (unless you wanna attempt it)
